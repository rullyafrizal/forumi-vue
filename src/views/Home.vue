<template>
  <div>
    ...
    <div class="pt-5 pb-10 px-5 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 place-items-center gap-y-8">
      <QuestionCard v-for="card in 12" :key="card"/>
    </div>
